...
double readSEBamToBed12Map(BamReader &reader, chromBed12Map &bed12Hash, int skipDeletion=0, int skipSplice=0, int collapser=0, int skipBigClip=0);

double readPEBamToBed6MapNew(BamReader &reader, chromBed6Map &bed6Hash, int maxInsertLen);

double readPEBamToBed12Map(BamReader &reader, chromBed12Map &bed12Hash, int skipDeletion=0, int skipSplice=0, int collapser=0, int skipBigClip=0);
