...
double readSEBamToBed12Map(BamReader &reader, chromBed12Map &bed12Hash, int skipDeletion, int skipSplice, int collapser, int skipBigClip)
...
double readPEBamToBed12Map(BamReader &reader, chromBed12Map &bed12Hash, int skipDeletion, int skipSplice, int collapser, int skipBigClip)
// must at same chromosome
{
  int i            = 0;
  double totalNum  = 0;
